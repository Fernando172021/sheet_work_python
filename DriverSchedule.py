...
class DriverSchedule:
        def __init__(self):
            ...
            register_winget('word_init', self.word_init)
            ...
            register_winget('inputLabel2', self.inputLabel2)
            ...
            register_input('inputValue2', self.inputValue2)
            ...
            register_winget('inputLabel3', self.inputLabel3)
            ...
            register_input('inputValue3', self.inputValue3)
            ...
            register_winget('inputLabel4', self.inputLabel4)
            ...
            register_input('inputValue4', self.inputValue4)
            ...
            register_winget('inputLabel5', self.inputLabel5)
            ...
            register_input('inputValue5', self.inputValue5)
            ...
            register_winget('end_word', self.end_word)
